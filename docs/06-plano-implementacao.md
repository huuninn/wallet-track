...
>
> **⚠️ NOTA DE REMOÇÃO GCP (jun/2026):** A infraestrutura GCP (Cloud Run, Cloud Build, Cloud Scheduler, Artifact Registry, Secret Manager) foi removida. O deploy passou para Docker container (VPS planejada). O milestone M10 (Deploy Cloud Run) é histórico — substituído pelo deploy em VPS (task futura).
